...
const tourSteps = [
    ...
    },
    {
        ...
        why: "<b>How Clutch makes money from this — additive to today's revenue, no cannibalization:</b><br><br><b>① Funnel extension</b> · <em>the core revenue story</em><br>Agent answer cites Clutch, CMO clicks the clutch.co link, lands on SilverThread's profile, fills contact form. That qualified intent converts through <b>Clutch's existing monetization</b> — whether that's Clutch+ subscriptions, lead-routing fees, or sponsored placement. Same mechanisms, new traffic source. The CMO was never going to visit clutch.co without MCP. With MCP she visits AND converts. Pure funnel expansion.<br><br><b>② Sponsored placement in agent answers</b> · <em>future optionality</em><br>Same sponsored-placement economics Clutch sells on category pages today — but extended to the agent's response surface. Provider pays for prominence when the agent lists matches.",
