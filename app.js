...
const tourSteps = [
    ...
    {
        target: '.mcp-wrap',
        title: "MCP Agent Layer — Extending Clutch's Funnel to AI Research",
        audience: "For buyers starting research in AI agents",
        audienceCls: "off-clutch",
        desc: "Audience ② starts research by asking Claude or ChatGPT \"find me a HIPAA-compliant marketing agency.\" The AI queries <b>Clutch's MCP server</b> and returns verified-review-backed matches <b>with deep links to clutch.co profiles</b>. The agent becomes a new top-of-funnel driving buyers TO clutch.co for deeper evaluation.",
        why: "Clutch isn't the only B2B marketplace — GoodFirms and DesignRush exist — but has the largest verified-review corpus and most rigorous human verification. <b>No competitor has shipped MCP yet.</b> First to ship wins default-citation status: when an AI says \"according to Clutch reviews,\" that carries weight because the verification is real.",
        before: () => {
    ...
    {
        target: '#mcpRun',
        title: "Watch a Real Agent Query — And the Money Flow",
        audience: "For buyers starting research in AI agents",
        audienceCls: "off-clutch",
        desc: "A hospital-system CMO asks her AI assistant for a HIPAA-compliant marketing agency. The agent calls Clutch's MCP server. Matches stream back with reasoning AND deep links to clutch.co profiles.",
        why: "<b>Four distinct monetization paths — every one is net-new or additive to today's clutch.co revenue:</b><br><br><b>① Funnel extension</b> · <em>biggest slice, same model as today</em><br>Agent answer cites Clutch, CMO clicks the clutch.co link, lands on SilverThread's profile, fills contact form. Provider pays Clutch for the qualified lead — <b>same fee, same lead-gen model as today</b>, just sourced from an AI instead of Google.<br><br><b>② Direct agent-routed leads</b> · <em>net-new revenue</em><br>If CMO says \"connect me with SilverThread\" inside the AI, the agent calls <code>clutch.route_lead()</code>. That sends her qualified intent straight to the provider. Provider pays the same per-lead fee — but <b>this transaction would not have happened at all without MCP</b>. Before, she'd get a random AI answer and walk away.<br><br><b>③ Enterprise data licensing</b> · <em>brand-new SaaS tier</em><br>Think Deloitte: their 1,000 consultants help clients pick vendors. They build an internal AI for speed. They pay Clutch <b>$50K–$500K/year</b> to embed Clutch's verified review data in that internal tool — like a Bloomberg terminal subscription. <b>Not a per-lead fee. A recurring subscription.</b> Pure net-new revenue Clutch has no equivalent of today.<br><br><b>④ Sponsored placement in agent answers</b> · <em>future optionality</em><br>Same sponsored-placement economics as clutch.co today — but in the agent's response. Provider pays for prominence when the agent lists matches. Extends an existing ad product to a new surface.",
