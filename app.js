...
const tourSteps = [
    ...
    },
    {
        ...
        desc: "Audience ② starts their research by asking Claude or ChatGPT \"find me a HIPAA-compliant marketing agency.\" The AI queries <b>Clutch's MCP server</b> and returns verified-review-backed matches <b>with deep links to clutch.co profiles</b>. The agent becomes a new top-of-funnel that drives buyers TO clutch.co for deeper evaluation.",
        why: "Clutch is invisible in the AI research phase today. MCP fixes that. Most of those buyers click through the citation to clutch.co and convert through the existing lead-gen funnel — this is <b>extension, not replacement</b>. Every AI answer citing \"according to Clutch reviews\" also compounds brand authority.",
        before: () => {
    ...
    },
    {
        ...
        audience: "For buyers starting research in AI agents",
        audienceCls: "off-clutch",
        desc: "A buyer at a hospital system asks their AI assistant for a marketing agency. The agent calls Clutch's MCP server. Verified matches stream back — each citing the real Clutch reviews it came from, with links back to the full profile on clutch.co.",
        why: "<b>Four monetization paths, all additive to today's revenue:</b><br><br>① <b>Funnel extension</b> (biggest): agent cites Clutch, buyer clicks through to clutch.co profile, converts via existing lead-gen.<br>② <b>Direct agent-routed leads</b>: buyers who decide inside the AI — agent calls <code>clutch.route_lead</code>, provider pays same as today. Pure net-new.<br>③ <b>Enterprise data licensing</b>: companies embedding Clutch in internal procurement AIs pay an API subscription. New SaaS tier.<br>④ <b>Sponsored placement in agent answers</b>: future optionality, like Google search ads for AI.",
        try: "We'll click Run Query. Watch the request stream out — then the structured response stream back, with clutch.co citations in the match results.",
        before: () => {
